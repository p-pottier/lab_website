...
export const PI_BIO: string[] = [
  ...
  "Outside of academia, I thrive when I am surrounded by natural landscapes. I particularly enjoy surfing, hiking, camping, observing wildlife, and picking wild mushrooms. I also love meeting new people, interacting with animals, discovering new cultures, and trying all the craft beers and cuisines the world has to offer.",
];
...
export const CURRENT_MEMBERS: Person[] = [
  ...
  },
  {
    ...
    blurb:
      "Emil looks after our zebrafish colony and keeps the experiments running. He maintains the aquarium facility, breeds and raises the fish we work with, and helps run the assays. The quality of our results starts with the quality of his animal care.",
    links: [],
  },
];
